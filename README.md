  ...
  **Cleaning Data & Topic Modeling**
  ...
  - Fact Check Dataset
   ...
   - Topic Modeling
     ...
     Run **Topic Modeling.ipynb** to first import data we saved in PostgreSQL server, then combining the text columns of the two datasets and use the LDA model to do topic modeling. The topic modeling results will also be stored in PostgreSQL server.
